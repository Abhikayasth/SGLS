    ...
    <footer className="bg-gray-900 text-white py-12 px-4 md:px-8">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-start space-y-8 md:space-y-0 md:space-x-12">
        ...
        <div className="flex-1">
          <h1 className="text-4xl font-bold mb-4 text-teal-400">Shree Ganan Loan Services</h1>
          <p className="text-lg leading-relaxed">
            At Shree Ganan Loan Services, we are dedicated to providing tailored financial solutions to help you achieve your financial goals. From personal and home loans to business financing, we offer competitive rates and exceptional service.
          </p>
        </div>
        ...
        <div className="flex-1">
          ...
          <ul className="space-y-4">
            ...
            <li className="flex items-center text-gray-300 hover:text-teal-400 transition-colors duration-300">
              ...
              <a href="mailto:info@shreegananloanservices.com" className="underline">roshanfiremarshal@gmail.com</a>
            </li>
            <li className="flex items-center text-gray-300 hover:text-teal-400 transition-colors duration-300">
              <FaPhone size={20} className="mr-3" />
              <a href="tel:+1987654321" className="underline">+91 9033409781</a>
            </li>
            <li className="flex items-center text-gray-300 hover:text-teal-400 transition-colors duration-300">
      ...
      <div className="text-center mt-12 border-t border-gray-700 pt-6">
        <p className="text-sm text-gray-400">
          © {new Date().getFullYear()} Shree Ganan Loan Services. All rights reserved. | 
