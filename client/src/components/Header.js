...
const Header = () => {
  ...
  return (
    <header className="bg-gradient-to-r from-blue-600 to-teal-500 text-white shadow-md fixed w-full top-0 left-0 z-50">
      <div className="container mx-auto px-4 py-2 border-b border-gray-700">
        <div className="flex justify-between items-center text-sm">
          ...
          <div className="hidden md:flex justify-between w-full">
            ...
            <div className="flex space-x-4 text-gray-200">
              <a href="/login" className="transition-colors hover:text-gray-300">
                Login
              </a>
              <span>/</span>
              <a
      ...
      >
        ...
        <div className="mt-6 flex flex-col space-y-4">
          ...
          <Link smooth to="#service" className="text-lg font-semibold" onClick={toggleMenu}>
            Services
          </Link>
          <Link smooth to="#calculator" className="text-lg font-semibold" onClick={toggleMenu}>
            Calculator
          </Link>
