...
import { FaHome, FaBusinessTime, FaCar, FaMoneyCheckAlt } from 'react-icons/fa'; // Icons for loans
import { MdHealthAndSafety, MdOutlineHomeWork } from 'react-icons/md'; // Icons for insurance
...
const ApplyPage = () => {
  ...
  return (
    <div className="container mx-auto py-16 px-4">
      ...
      <h1 className="text-5xl font-bold text-center text-blue-800 mb-8">Choose Your Ideal Loan</h1>
      <p className="text-lg text-center text-gray-700 mb-12 max-w-3xl mx-auto">
        Explore a variety of loan options tailored to your financial needs. From personal loans to home loans, we offer customized plans to make your dreams come true. Select the loan type that suits you and get fast, secure approval!
      </p>
      ...
      {/* Selected Loan and Apply Button */}
      {selectedLoan && (
        <div className="text-center mt-12">
          <p className="text-lg mb-6">
            You have selected <strong>{selectedLoan}</strong>. Click below to start your application now!
          </p>
          <button
